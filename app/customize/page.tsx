...
import { getProductById as getApiProductById, transformProduct } from '@/lib/api/client'
...
export default function CustomizePage() {
  ...
  useEffect(() => {
    async function loadProduct() {
      ...
      if (!productId) {
        // Default to classic hoodie if no product specified
        const defaultProduct = getLocalProductById('classic-hoodie')
      ...
      // Fallback to classic hoodie if still not found
      if (!foundProduct) {
        foundProduct = getLocalProductById('classic-hoodie')
      }
